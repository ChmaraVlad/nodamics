...
export interface IParameterAutocompleteProps<Value> {
    value?: Value
    onChange?: (e: Value | null) => void
    readonly options: Value[]
    label?: string
}

 type ParameterAutocompleteFN = <Value>(props: IParameterAutocompleteProps<Value>) => JSX.Element
export const ParameterAutocomplete: ParameterAutocompleteFN = ({options = [], label, value = null  , onChange}) => {
    return (
        <Autocomplete
            sx={{
                width: '100%',

import {
    ...
    ENodeAction,
    ENodeTrigger,
    IDiagramNodeBaseData, IDiagramNodeStyle,
    IReactFlowNode
} from "../../../interface";
import {initialNodeDiagramElement, loopSize, nodeActiveColorMap} from "../../../constant";
...
export const createBaseNode = ({type, position, layerId}: {
    ...
    const activeBorderColor = nodeActiveColorMap[type]
    const baseNodeProps: IDiagramNodeStyle = {
        ...initialNodeDiagramElement,

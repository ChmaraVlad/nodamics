...
import {DIAGRAM_RUN_DURATION, RightMenu} from "../../constant";
...
export const diagramEditorSlice = createSlice({
    ...
    reducers: {
        ...
        setEditElement: (state, {payload}: PayloadAction<{
            ...
            state.rightMenu = RightMenu.NODE
        ...
        setFootprintQueries: (state, {payload}: PayloadAction<{queries?: FootprintQuery[]}>) => {
            state.footprintQueries.queries = payload.queries
        },
        setIsInteractive: (state, {payload}: PayloadAction<boolean>) => {
            state.isInteractive = payload
        },
        setRightMenu: (state, {payload}: PayloadAction<RightMenu | undefined>) => {
